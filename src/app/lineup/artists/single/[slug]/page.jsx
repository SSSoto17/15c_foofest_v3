...
export default async function ArtistSingle({ params }) {
  ...
  const mon = { day: "Monday", acts: [...schedule.Midgard.mon, ...schedule.Jotunheim.mon, ...schedule.Vanaheim.mon] };
  const tue = { day: "Tuesday", acts: [...schedule.Midgard.tue, ...schedule.Jotunheim.tue, ...schedule.Vanaheim.tue] };
  const wed = { day: "Wednesday", acts: [...schedule.Midgard.wed, ...schedule.Jotunheim.wed, ...schedule.Vanaheim.wed] };
  const thu = { day: "Thursday", acts: [...schedule.Midgard.thu, ...schedule.Jotunheim.thu, ...schedule.Vanaheim.thu] };
  const fri = { day: "Friday", acts: [...schedule.Midgard.fri, ...schedule.Jotunheim.fri, ...schedule.Vanaheim.fri] };
  const sat = { day: "Saturday", acts: [...schedule.Midgard.sat, ...schedule.Jotunheim.sat, ...schedule.Vanaheim.sat] };
  const sun = { day: "Sunday", acts: [...schedule.Midgard.sun, ...schedule.Jotunheim.sun, ...schedule.Vanaheim.sun] };
